...
Remember to read the [Section: Setting up Binder](https://github.com/ines/course-starter-r) and checking that the file [*install.R*](https://github.com/juliasilge/supervised-ML-case-studies-course/blob/master/binder/install.R) has all the packages used in the tutorial -> 📁 [**binder** folder.](https://github.com/juliasilge/supervised-ML-case-studies-course/tree/master/binder)
