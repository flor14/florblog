...
```{r echo=FALSE}
knitr::include_url("https://flor14.github.io/reproducibility_slides_en/binder_reproducible_environments.html#16")
...
> If you want to deploy your Shiny app using `shinyapp.io` you can find instructions [in this webpage](https://shiny.rstudio.com/articles/shinyapps.html#:~:text=Shinyapps.io%20is%20a%20platform,such%20as%20the%20RStudio%20IDE)
...
I prepared these [slides](https://flor14.github.io/r_de_reproducibilidad/r_de_reproducibilidad.html#1) as part of a meetup to present the first ReproHack in Spanish to be held at the [LatinR](https://latin-r.com/en) 2020 conference.
...
* Steps to share interactive enviroments with Binder.


```{r echo=FALSE}
knitr::include_url("https://flor14.github.io/reproducibility_slides_en/binder_reproducible_environments.html#21")

```

These slides are also in [Spanish](https://flor14.github.io/r_de_reproducibilidad/r_de_reproducibilidad.html#1).
...
You can ask questions about Binder [here](discourse.jupyter.org).
