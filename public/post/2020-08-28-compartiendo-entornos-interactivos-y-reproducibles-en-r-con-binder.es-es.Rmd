...
Hace poco participé de la [CarpentryCon](https://carpentrycon.org/), no sólo ayudando en [las traducciones de lecciones al español](https://carpentries.org/blog/2020/08/Hablamos/), sino también dando un pequeño workshop junto a [Pablo Bernabeu](https://github.com/pablobernabeu/) sobre Reproducibilidad y Ciencia Abierta donde expliqué brevemente el uso de Binder.
...
> Tutoriales: Binder es parte del framework de Inés Montani para generar tutoriales de R y Python, sino que también puede usarse para compartir tus [tutoriales realizados con el paquete learnR, tal como lo explica este blog post](https://syoh.org/learnr-tutorial/) 
...
```{r echo=FALSE}
knitr::include_url("https://flor14.github.io/r_de_reproducibilidad/r_de_reproducibilidad.html#21")
