...
## ¿Qué tan buena tiene que ser mi aplicación Shiny?

Depende del lugar de publicación. En mi experiencia con JOSS, debe hacer que su software esté disponible en un repositorio abierto (GitHub, Bitbucket, etc.) e incluir una licencia de código abierto aprobada por OSI. Lea más aquí sobre los otros [requisitos](https://joss.readthedocs.io/en/latest/submitting.html#submission-requirements).
